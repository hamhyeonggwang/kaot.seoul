...
export default function MemberNewsForumPage() {
  ...
  const [posts, setPosts] = useState([
    {
      id: 1,
      title: '회원 소식 공유',
      content: '회원 여러분의 개인적인 소식과 근황을 공유하는 공간입니다. 새로운 경험과 성과를 함께 나누어 보세요.',
      author: '김회원',
      date: '2024-01-10',
      views: 89,
      likes: 12,
    ...
    {
      id: 2,
      title: '작업치료사 자격증 취득 축하',
      content: '최근 작업치료사 자격증을 취득하신 회원분들을 축하드립니다. 앞으로도 좋은 치료사가 되시길 바랍니다.',
      author: '박축하',
      date: '2024-01-09',
      views: 67,
      likes: 25,
    ...
    <main>
      ...
      <section className="bg-kaot-green-600 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-4">회원소식</h1>
          <p className="text-xl text-kaot-green-100">회원들의 개인적인 소식과 근황을 공유하는 공간</p>
        </div>
      </section>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center mb-2">
                    <span className="bg-purple-100 text-purple-700 text-xs font-medium px-2 py-1 rounded mr-3">
                      회원소식
                    </span>
