  ...
  const newsData = [
    {
      ...
      content: '대한작업치료사협회 서울지부 소속 작업치료사 중 자발적인 동호회 및 각종 모임을 구성한 경우 지원하여 회원 상호간의 친목도모 및 동료의식을 함양하는 "2025년 서울특별시 작업치료사회 자조모임 지원 사업"을 진행합니다. 총 4팀을 모집하며, 최대 50만원의 활동지원금을 지원합니다.',
      category: '지부사업',
      date: '2025-05-12',
      author: 'KAOT 서울지부',
      views: 89,
    ...
    },
    {
      ...
      content: '서울시교육청에서 진행하는 긍정적행동지원(Positive Behavior Support, PBS) 사업에 참여하는 작업치료사들을 지원하는 사업입니다. 특수교육 현장에서 학생들의 긍정적인 행동 변화를 이끌어내기 위한 전문적인 작업치료 서비스를 제공하며, 교육 현장의 작업치료사 역량 강화를 위한 다양한 지원 프로그램을 운영합니다.',
      category: '지부사업',
      date: '2025-02-15',
      author: 'KAOT 서울지부',
      views: 56,
    ...
    },
    {
      ...
      content: '2025년 2월 8일 지역사회 통합돌봄 사업협력 성과보고회가 성공적으로 개최되었습니다. 서울지부가 지역사회 기반 통합돌봄 서비스에 참여한 작업치료사들과 함께 그간의 성과를 공유하고, 향후 사업 발전 방향에 대해 논의하는 자리를 마련했습니다. 지역사회 내 취약계층의 삶의 질 향상과 건강한 지역사회 조성에 기여한 작업치료사들의 노력을 인정하고, 지속적인 협력을 위한 방안을 모색했습니다.',
      category: '지부사업',
      date: '2025-02-08',
      author: 'KAOT 서울지부',
      views: 42,
